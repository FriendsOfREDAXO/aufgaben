...
class rex_aufgaben
{
    ...
    */
    ...
    public function createMailText($aktuelle_id)
    {
        $body = "Beispiel";
        $sql = rex_sql::factory();
  ...
  <tr>
    ...
    public function checkTime($aktuelle_id)
    {
    ...
    // MAILS
    public function send_mails($email_adressen, $aktuelle_id, $aufgabe, $betreff, $bodyText, $responseId)
    {
